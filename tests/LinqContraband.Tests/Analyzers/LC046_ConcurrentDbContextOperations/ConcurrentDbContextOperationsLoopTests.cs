...
namespace TestApp
{
    ...
    public sealed class Program
    {
        public async Task Run(AppDbContext db, bool skipDrain)
        {
            var pending = {|#0:db.SaveChangesAsync()|};
            do
            {
                if (skipDrain) break;
                await pending;
    ...
    [Fact]
    public async Task UninvokedClosureIsNotEscape_Triggers()
    {
        var test = @"using Microsoft.EntityFrameworkCore;
using System;
using System.Threading.Tasks;" + EfMock + @"
namespace TestApp
{
    ...
    public sealed class Program
    {
        ...
        {
            var pending = {|#0:db.SaveChangesAsync()|};
            Func<Task<int>> getPending = () => { return pending; };
            await {|#1:db.SaveChangesAsync()|};
            await pending;
        }
    }
    ...
    [Fact]
    public async Task UninvokedLocalFunctionReturnIsNotCompletion_Triggers()
    {
        var test = @"using Microsoft.EntityFrameworkCore;
using System.Threading.Tasks;" + EfMock + @"
namespace TestApp
{
    ...
    public sealed class Program
    {
        ...
        {
            var pending = {|#0:db.SaveChangesAsync()|};
            Task<int> GetPending() { return pending; }
            await {|#1:db.SaveChangesAsync()|};
            await pending;
        }
    }
    ...
    [Fact]
    public async Task UninvokedParenthesizedLambdaReturnIsNotCompletion_Triggers()
    {
        var test = @"using Microsoft.EntityFrameworkCore;
using System;
using System.Threading.Tasks;" + EfMock + @"
namespace TestApp
{
    ...
    [Fact]
    public async Task UninvokedCastLambdaReturnIsNotCompletion_Triggers()
    {
        var test = @"using Microsoft.EntityFrameworkCore;
using System;
using System.Threading.Tasks;" + EfMock + @"
namespace TestApp
{
    ...
    public sealed class Program
    {
        ...
        {
            var pending = {|#0:db.SaveChangesAsync()|};
            Func<Task<int>> getPending = (Func<Task<int>>)(() => { return pending; });
            await {|#1:db.SaveChangesAsync()|};
            await pending;
        }
    }
