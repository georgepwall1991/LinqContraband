...
");
    ...
    [Fact]
    public async Task ExecuteDelete_WithParenthesizedIsPatternDeletedThenConvert_ShouldNotTrigger()
    {
        var test = App(@"
    public interface ISoftDelete { bool IsDeleted { get; set; } }
    public sealed class User : ISoftDelete
...
");
    ...
    [Fact]
    public async Task ExecuteDelete_WithParenthesizedNegatedIsPatternContinueThenConvert_ShouldNotTrigger()
    {
        var test = App(@"
    public interface ISoftDelete { bool IsDeleted { get; set; } }
    public sealed class User : ISoftDelete
