...
Current local verification (2026-06-26, release-bound LC031 unbounded materialization guidance pass):
...
- `dotnet test tests/LinqContraband.Tests/LinqContraband.Tests.csproj --framework net10.0 --filter "FullyQualifiedName~LC031_UnboundedQueryMaterialization" --verbosity minimal` passed with **22 LC031 tests**.
- `dotnet test LinqContraband.sln --no-build --framework net10.0 --verbosity minimal` passed with **1157 tests**.
