...
Current verification (2026-07-05, stacked LC023+LC027+LC017+LC035+LC016+LC015+LC045+LC044+LC007+LC036+LC010+LC025+LC024 fix branches after the 5.6.38 release):
...
- Full local net10.0 suite passes 1294 tests on the stacked LC023+LC027+LC017+LC035+LC016+LC015+LC045+LC044+LC007+LC036+LC010+LC025+LC024 fix branch; `RuleCatalogDocGenerator --check`, `dotnet build LinqContraband.sln --no-restore --configuration Release`, and `SampleDiagnosticsVerifier` across net8.0/net9.0/net10.0 all pass on the LC024 branch.
