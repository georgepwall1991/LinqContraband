...
- Full local net10.0 suite passes 1702 tests on the LC010 local-delegate loop invocation guard branch. `RuleCatalogDocGenerator --check` and `SampleDiagnosticsVerifier` for net10.0 pass locally; CI covers net8.0/net9.0 on Ubuntu.
