...
Current verification (2026-07-04, stacked LC023+LC027+LC017+LC035+LC016+LC015+LC045+LC044+LC007 fix branches after the 5.6.38 release):
...
- Full local net10.0 suite passes 1285 tests on the stacked LC023+LC027+LC017+LC035+LC016+LC015+LC045+LC044+LC007 fix branch; `RuleCatalogDocGenerator --check`, `dotnet build LinqContraband.sln --no-restore --configuration Release`, and `SampleDiagnosticsVerifier` across net8.0/net9.0/net10.0 all pass on the LC007 branch.
